      ...
      <section className="w-full md:w-1/2 flex items-center justify-center px-4 py-10">
        ...
        <div className="w-full max-w-lg bg-white border border-gray-300 rounded shadow p-6 md:p-8">
          ...
          <div className="text-sm text-gray-700 mb-6 space-y-1">
            ...
            <p>• You will be redirected to your dashboard after login.</p>
          </div>
          ...
          <form className="space-y-5">
            ...
            {/* Checkbox */}
            <div className="flex items-start gap-2 md:ml-[33%]">
            ...
            {/* Buttons */}
            <div className="flex items-center gap-4 md:ml-[33%] flex-wrap">
              <button
                type="submit"
                className="bg-[#8B1D2C] text-white px-6 py-2 rounded font-semibold hover:bg-[#6F1622]"
              >
                LOG IN
              </button>
            ...
            {/* 🔹 SIGNUP CTA */}
            <div className="md:ml-[33%] pt-4 text-sm text-gray-700">
